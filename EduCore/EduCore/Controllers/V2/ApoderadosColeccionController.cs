...
{
    [ApiController]
    [Route("api/v2/apoderados-coleccion")]
    ...
    public class ApoderadosColeccionController : ControllerBase
    {
        ...
        [HttpGet("{ids}", Name = "ObtenerApoderadosPorIdsV2")]
        ...
        public async Task<ActionResult> Post(IEnumerable<ApoderadoCreacionDTO> apoderadoCreacionDTO)
        {
            ...
            return CreatedAtRoute("ObtenerApoderadosPorIdsV2", new { ids = idsString }, apoderadosDTO);
        }
    }
}
