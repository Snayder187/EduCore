...
namespace EduCore.Controllers.V1
{
    ...
    public class AlumnoController : ControllerBase
    {
        ...
        [HttpGet("{id:int}", Name = "ObtenerAlumnoV1")]
        [AllowAnonymous]
        [OutputCache(Tags = [cache])]
        ...
        public async Task<ActionResult> Post(AlumnoCreacionDTO alumnoCreacionDTO)
        {
            ...
            return CreatedAtRoute("ObtenerAlumnoV1", new { id = alumno.Id }, alumnoDTO);
        }
