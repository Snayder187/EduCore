...
namespace EduCore.Controllers.V1
{
    ...
    public class ApoderadoController: ControllerBase
    {
        ...
        [HttpGet(Name = "ObtenerApoderadosV1")]
        [AllowAnonymous]
        [OutputCache(Tags = [cache])]
        [ServiceFilter<HATEOASApoderadosAttribute>()]
        public async Task<IEnumerable<ApoderadoDTO>> 
            Get([FromQuery] PaginacionDTO paginacionDTO)
        {
            return await servicioApoderadosV1.Get(paginacionDTO);
        }

        [HttpGet("{id:int}", Name = "ObtenerApoderadoV1")]
        [AllowAnonymous]
        ...
        [OutputCache(Tags = [cache])]
        [ServiceFilter<HATEOASApoderadoAttribute>()]
        public async Task<ActionResult<ApoderadoConAlumnoDTO>> Get([Description("El id del apoderado")]int id)
        {
        ...
        [HttpGet("filtrar", Name = "FiltrarApoderadosV1")]
        [AllowAnonymous]
        ...
        [HttpPost(Name = "CrearApoderadoV1")]
        public async Task<ActionResult> Post(ApoderadoCreacionDTO apoderadoCreacionDTO)
        {
            ...
            return CreatedAtRoute("ObtenerApoderadoV1", new { id = apoderado.Id }, apoderadoDTO);
        }

        [HttpPost("con-foto", Name = "CrearApoderadoConFotoV1")]
        ...
        [HttpPut("{id:int}", Name = "ActualizarApoderadoV1")]
        ...
        [HttpPatch("{id:int}", Name = "PatchApoderadoV1")]
        ...
        [HttpDelete("{id:int}", Name = "BorrarApoderadoV1")]
