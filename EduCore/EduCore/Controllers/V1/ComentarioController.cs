...
{
    [ApiController]
    [Route("api/v1/apoderados/{apoderadoId:int}/comentarios")]
    [Authorize]
    public class ComentarioController : ControllerBase
    {
        ...
        public async Task<ActionResult> Post(int apoderadoId, ComentarioCreacionDTO comentarioCreacionDTO)
        {
            ...
            return CreatedAtRoute("ObtenerComentarioV1", new { id = comentario.Id, apoderadoId }, comentarioDTO);
        }
        ...
        public async Task<ActionResult> Delete(Guid id, int apoderadoId)
        {
            ...
            comentarioDB.EstadoBorrado = true;
